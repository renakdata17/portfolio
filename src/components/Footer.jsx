export default function Footer() {
  return (
    <footer className="flex flex-col items-center justify-between gap-5 border-t border-line px-5 py-[34px] text-muted sm:flex-row sm:px-9 lg:px-[72px]">
      <span>© 2026 Ondrej Renak</span>
      <span>Senior Backend Engineer · Python / Django / Data Engineering</span>
      <a
